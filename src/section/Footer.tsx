...
const Footer = () => {
  return (
    <div className="relative w-full h-screen  px-5 py-2 bg-[url('/assets/finedining3.png')] bg-cover bg-center sm:px-10 sm:py-5 lg:px-20 lg:py-2 flex flex-col overflow-hidden">
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <motion.div
          variants={containerVariants}
          className="flex flex-col gap-4 items-center lg:items-center lg:flex-row lg:justify-center "
        >
          <motion.div
            variants={itemVariants}
            whileHover={{ scale: 1.05 }}
            className="flex flex-col items-center gap-1 sm:flex-row sm:justify-center sm:gap-4 lg:justify-start "
          >
            <motion.div
              animate={{
                y: [0, -5, 0],
        ...
        >
          <Button
            ...
            textClassName="text-2xl sm:text-4xl lg:text-xl "
          >
            GO TO MENU
          </Button>
        </motion.div>
            ...
            {socials.map((social, index) => (
              ...
              >
                <LinkItem className="text-lg relative sm:text-2xl lg:text-base">
                  {social}
                  <motion.div
                    className="absolute bottom-0 left-1/2 -translate-x-1/2 h-px bg-secondary"
                    initial={{ width: "50%" }}
